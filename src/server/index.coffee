...
mongoUrl = process.env.MONGO_URL || process.env.MONGOHQ_URL ||
    'mongodb://localhost:27017/fin-spa'
...
model.on 'insert', 'records', (record, value) ->
...
expressApp
    ...
    .use(express.session
        secret: process.env.SESSION_SECRET || "\xc9\x0c\xa14\xf4\xf6w`\xbd\xbd\xb8\xcd^\xe9lF\xbf07\x01"
